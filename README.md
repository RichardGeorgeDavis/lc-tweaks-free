...
- **AI Agent Readiness:** serve public content as Markdown for agents, add Content Signals, publish honest discovery headers, show readiness diagnostics, and optionally add an Apache `.htaccess` fallback for cached homepage Link headers.
