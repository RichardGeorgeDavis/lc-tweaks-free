<?php
/**
 * @package Enable Divi Builder by Default
 * @version 1.1
 */

 if (!class_exists('LC_Kit_EnableBuilderByDefault')) {

 	class LC_Kit_EnableBuilderByDefault {
 	...
 	(new LC_Kit_EnableBuilderByDefault)->init();
 }
