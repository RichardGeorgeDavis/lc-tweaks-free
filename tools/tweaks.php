...
<div id="tweaks" class="tool <?php echo $active_tab == 'tweaks' ? 'tool-active' : ''; ?>">
	...
	<div class="toolbox" style="padding:0 0 30px;">
		<div class="info" style="background:transparent;">
			<h4><?php esc_html_e( 'What are the WordPress tweaks?', 'divi-lc-kit' ); ?></h4>
			<p><?php echo esc_html_e( 'Common WordPress housekeeping tweaks to harden, declutter, and speed up your site.', 'divi-lc-kit' ); ?></p>
			<p><?php echo esc_html_e( 'Use these when you want global behaviour changes without touching code.', 'divi-lc-kit' ); ?></p>
		</div>
	</div>

	<h2 class="tool-section"><?php echo esc_html_e( 'Wordpress', 'divi-lc-kit' ); ?></h2>
	<div class="tool-wrap">

		<div class="lc-kit trigger">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Antispam Email Shortcode', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Converts selected email addresses characters to HTML entities to block spam bots.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			...
			<div class="lc-kit first nopad">
				...
				<div class="box-content">
					<div class="info">
						...
						<p>
							<?php echo esc_html_e( 'Add emails with a shortcode', 'divi-lc-kit' ); ?>
							</u>:</p>
						<p>
		...
		<div class="lc-kit trigger">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Footer Date Shortcode', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Add the current year to the copyright line.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
			...
			<div class="lc-kit first nopad">
				...
				<div class="box-content">
					<div class="info">
						<h4><?php echo esc_html_e( 'How to use it:', 'divi-lc-kit' ); ?></h4>
						<p>
							<?php echo esc_html_e( 'Add shortcode in footer', 'divi-lc-kit' ); ?>
							</u>:</p>
						<p>
							<strong><?php echo esc_html_e( '&#169;[footer_date_]', 'divi-lc-kit' ); ?></strong> - adds the
		...
		<div class="lc-kit trigger">
			<div class="box-title">
				<h3><span class="new">new</span><?php echo esc_html_e( 'Mobile Browser Theme Color', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p><?php echo esc_html_e( "Set the theme color used by mobile browsers for the address bar/header.", 'divi-lc-kit' ); ?></p>
				</div>
			</div>
			<div class="box-content minibox">
				<div class="checkbox">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Add User Role to Body Class', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p><?php echo esc_html_e( 'Append the current user role(s) as body classes for targeted styling.', 'divi-lc-kit' ); ?></p>
				</div>
			</div>
			<div class="box-content minibox">
				<div class="checkbox">
		...
		<div class="lc-kit trigger">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Disable Admin New User Notification Emails', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p><?php echo esc_html_e( 'Stop WordPress from emailing the site admin when a new user account is registered, while still allowing the new user email to be sent.', 'divi-lc-kit' ); ?></p>
				</div>
			</div>
			<div class="box-content minibox">
				<div class="checkbox">
		...
		<div class="dlck-hide">
			<div class="lc-kit first nopad">
				...
				<div class="box-content">
					<div class="info">
						<p><?php echo esc_html_e( 'This applies globally to WordPress registration emails. If the WooCommerce customer-registration admin email tweak is also enabled, LC Tweaks will switch the Woo setting off because the global rule takes precedence.', 'divi-lc-kit' ); ?></p>
					</div>
				</div>
			</div>
		</div>
	...
	<h2 class="tool-section"><?php echo esc_html_e( 'Builders & Gutenberg', 'divi-lc-kit' ); ?></h2>
	<div class="tool-wrap">

		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Disable Gutenberg', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Turn off the Gutenberg editor and block library assets.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Disable Widget Block Editor', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Use classic widgets instead of the block-based widget editor.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
	...
	<h2 class="tool-section"><?php echo esc_html_e( 'Images', 'divi-lc-kit' ); ?></h2>
	<div class="tool-wrap">

		<div class="lc-kit">
			<div class="box-title">
				<h3><span class="new">new</span><?php echo esc_html_e( 'Disable image scaling', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Disable WordPress auto resize function.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><span class="new">new</span><?php echo esc_html_e( 'Disable WordPress Image Sizes', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Remove the three WordPress sizes medium_large, 1536x1536, 2048x2048.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><span class="new">new</span><?php echo esc_html_e( 'Restore Infinite Media scrolling', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Restore Infinite WordPress Media Library scrolling.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
	...
	<h2 class="tool-section"><?php echo esc_html_e( 'Web Performance', 'divi-lc-kit' ); ?></h2>
	<div class="tool-wrap">

		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Disable Your RSS Feed', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Although its a great WordPress feature, if you aren’t interested in using RSS at all, you can disable it altogether.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Disable WordPress Search Feature', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Using WordPress to power a simple site, like a single landing page, you may wish to disable the platform’s search feature.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e( 'Disable All Comments', 'divi-lc-kit' ); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e( 'Turn off comments and trackbacks everywhere, hide existing comments, and remove comment menus.', 'divi-lc-kit' ); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
	...
	<div class="tool-wrap">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e('Restrict suggestions to the same YouTube channel', 'divi-lc-kit'); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e("Prevent displaying related videos.", "divi-lc-kit"); ?>
					</p>
				</div>
			</div>
			<div class="box-content minibox">
		...
		<div class="lc-kit">
			<div class="box-title">
				<h3><?php echo esc_html_e('Hide Related YouTube Video Suggestions', 'divi-lc-kit'); ?></h3>
				<div class="box-descr">
					<p>
						<?php echo esc_html_e("Prevent displaying related videos.", "divi-lc-kit"); ?>
					</p>
